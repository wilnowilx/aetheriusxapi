...
- 40 endpoints, ALL verified live with real USDC payments: maps ×5, token ×8,
  web ×4, data ×7, drift, DeFi ×8, forex ×3, news ×4
- Upstreams: OSM/Photon, Llama suite, Open-Meteo, Frankfurter, Firebase,
  Etherscan V2, dictionary/Datamuse, ip-api, Google DoH, public RPCs, CoinGecko…
