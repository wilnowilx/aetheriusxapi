import{r as n,j as e,C as j,S as w,O as C,u as m}from"./r3f-mhkaesY0.js";import{e as p,p as d,q as M,F as b,r as y}from"./three-Dt9xBCz9.js";function N(){const t=n.useMemo(()=>({time:{value:0},glowColor:{value:new p(11032055)},accentColor:{value:new p(14239471)}}),[]);return m(a=>{t.time.value=a.clock.elapsedTime}),e.jsxs("mesh",{scale:1.07,children:[e.jsx("sphereGeometry",{args:[2.2,48,48]}),e.jsx("shaderMaterial",{uniforms:t,vertexShader:`
        ...
        `,transparent:!0,depthWrite:!1,blending:d})]})}function A(){return e.jsx("group",{children:[0,1,2].map(t=>e.jsxs("mesh",{rotation:[Math.PI/2+t*.2,0,t*.35],children:[e.jsx("torusGeometry",{args:[2.3+t*.2,.008,8,128]}),e.jsx("meshBasicMaterial",{color:11032055,transparent:!0,opacity:.12-t*.03})]},t))})}function _(){const t=n.useRef(),a=n.useMemo(()=>{const s=document.createElement("canvas");s.width=512,s.height=256;const o=s.getContext("2d");return o.clearRect(0,0,512,256),o.font="bold 150px monospace",o.textAlign="center",o.textBaseline="middle",o.fillStyle="#d946ef",o.shadowColor="#d946ef",o.shadowBlur=44,o.fillText("x402",256,100),o.font="40px sans-serif",o.fillStyle="#a855f7",o.shadowBlur=22,o.fillText("Protocol",256,185),new y(s)},[]);return m(s=>{t.current&&(t.current.material.opacity=.7+.3*Math.sin(s.clock.elapsedTime*1.5))}),e.jsx("sprite",{ref:t,scale:[2.1,1.05,1],children:e.jsx("spriteMaterial",{map:a,transparent:!0,blending:d,opacity:.85,depthWrite:!1})})}function W(){const t=n.useMemo(()=>typeof window>"u"?!1:window.matchMedia("(pointer: coarse)").matches||window.innerWidth<768,[]);return e.jsxs(j,{camera:{position:[0,.3,10],fov:40},gl:{alpha:!0,antialias:!t,powerPreference:"high-performance"},onCreated:({gl:a})=>a.setClearColor(0,0),style:{position:"absolute",inset:0,width:"100%",height:"100%",background:"transparent"},dpr:[1,1.5],children:[e.jsx("ambientLight",{intensity:.1}),e.jsxs("group",{scale:1.4,children:[e.jsx(S,{}),e.jsx(N,{}),e.jsx(P,{}),e.jsx(O,{}),e.jsx(_,{}),e.jsx(A,{})]}),!t&&e.jsx(w,{radius:8,depth:20,count:250,factor:2,saturation:.5,fade:!0,speed:.5}),e.jsx(C,{autoRotate:!0,autoRotateSpeed:.8,enableZoom:!1,enablePan:!1,enableDamping:!0,dampingFactor:.08,rotateSpeed:.6,minPolarAngle:Math.PI*.25,maxPolarAngle:Math.PI*.75})]})}export{W as default};
