...
- Governance → `SECURITY.md` (private vuln reporting), `TERMS.md` (as-is,
  non-custodial, no SLA), `CODEOWNERS`, `CONTRIBUTING.md`, issue/PR templates,
  `CHANGELOG.md`, `CITATION.md`.
